...
* `xcube gen` can now interpret `start_date` and `stop_date` from a netcdfs attributes. This is relevant for unsing
  `xcube gen` for Sentinel-2 data processed and provided by Brockmann Consult. 
