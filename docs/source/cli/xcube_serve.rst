...
Find its API description `here <https://app.swaggerhub.com/apis-docs/bcdev/xcube-server>`_.
...
The Xcube server supports local NetCDF files or local or remote `Zarr <https://zarr.readthedocs.io/en/stable/>`_ directories.
