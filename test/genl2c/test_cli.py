...
# This test still fails, needs to be fixed
    def test_version(self):
        ...
        self.assertEqual(
                         '  cli, version 0.1.0.dev1', result.output)

# Keeping this test until the problem is isolved (issue #19 on GitHub) - it is commented out because of hardcoded paths
#     def test_missing_output_name(self):
#         result = self.invoke_cli(['--dir', '/home/alicja/Desktop/DCS4COP/Testing_naming_of_xcube_genl2/', '-f',
#                                   'zarr', '--region', '4.0,48.0,5.333333333333333,49.33333333333333',
#                                   '--size', '512,512', '--proc', 'default', '--append',
#                                   '/home/alicja/Desktop/DCS4COP/CMEMS_SST_201701_coords_arranged/20170*.nc'])
#         print(result.output)
#         print(result.exit_code)
