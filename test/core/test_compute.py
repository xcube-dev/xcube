...
class ComputeCubeTest(unittest.TestCase):
    ...
    def test_from_two_inputs(self):
        ...
        def my_cube_func(
            ...
            nonlocal calls
            calls.append(
                (analysed_sst, analysis_error, input_params, dim_coords, dim_ranges)
            )
    ...
    def test_from_two_inputs_reduce_time(self):
        ...
        def my_cube_func(
            analysed_sst: np.ndarray, analysis_error: np.ndarray
        ) -> CubeFuncOutput:
            nonlocal calls
    ...
    def test_invalid_cube_func(self):
        ...
        self.assertEqual(
            "invalid cube_func 'my_cube_func': expected 2 arguments, "
        ...
        self.assertEqual(
            "invalid cube_func 'my_cube_func': "
