...
class UnchunkDatasetTest(unittest.TestCase):
    ...
    def test_unchunk_data_var_coords_only(self):
        ...
        self.assertEqual(
            "variable 'C' is not a variable in 'test.zarr'", f"{cm.exception}"
        )
    ...
    def test_unchunk_invalid_path(self):
        ...
        self.assertEqual(
            "'test.zarr.zip' is not a valid Zarr directory", f"{cm.exception}"
        )
    ...
    def test_unchunk_invalid_vars(self):
        ...
        self.assertEqual(
            "variable 'times' is not a coordinate variable in 'test.zarr'",
            f"{cm.exception}",
        )
        ...
        self.assertEqual(
            "variable 'CHL' is not a variable in 'test.zarr'", f"{cm.exception}"
        )

    def _assert_cube_files(
        self,
        expected_a_files,
        expected_b_files,
        expected_time_files,
