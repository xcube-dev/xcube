...
class FileSetToLocalTest(unittest.TestCase):
    ...
    def test_to_local_from_memory_dir(self):
        ...
        self.assertTrue(os.path.isfile(local_file_set.path + "/__init__.py"))
        self.assertTrue(os.path.isfile(local_file_set.path + "/module1.py"))
        self.assertTrue(os.path.isfile(local_file_set.path + "/module2/__init__.py"))
...
class FileSetTest(unittest.TestCase):
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(
            {"path": "test_data/user_code", "includes": ["*.py"]}, file_set.to_dict()
        )

        file_set = FileSet("test_data/user_code", excludes=["NOTES.md"])
        self.assertEqual(
            {"path": "test_data/user_code", "excludes": ["NOTES.md"]},
            file_set.to_dict(),
        )
