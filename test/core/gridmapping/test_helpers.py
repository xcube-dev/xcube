...
def round_to_fraction_float(value, digits, resolution):
    return float(round_to_fraction(value, digits, resolution))
...
class RoundToFractionTestOld(unittest.TestCase):
