...
class FindGridMappingForVarTest(unittest.TestCase):
    ...
    def test_with_grid_mapping_and_named_coords(self):
        ds = xr.Dataset(
            data_vars={
    ...
    def test_with_grid_mapping_and_standard_name_lat_lon(self):
        ds = xr.Dataset(
            data_vars={
                "sst": self.new_data_var(
    ...
    def test_with_grid_mapping_and_standard_name_rot_lat_lon(self):
        ds = xr.Dataset(
            data_vars={
                "sst": self.new_data_var(
                    attrs={"grid_mapping": "crs"}
    ...
    def test_with_grid_mapping_and_standard_name_projected(self):
        ds = xr.Dataset(
            data_vars={
                "sst": self.new_data_var(
                    attrs={"grid_mapping": "crs"}
