...
class EncodeGridMappingTest(unittest.TestCase):
    def test_geographic_and_force_encoding(self):
        ...
        gm_ds = encode_grid_mapping(ds, gm, gm_name="spatial_ref", force=True)
    ...
    def test_geographic_and_do_not_force_encoding(self):
        ...
        gm_ds = encode_grid_mapping(ds, gm, gm_name="spatial_ref", force=False)
    ...
    def test_replace_gm_name(self):
        ...
        # Use new gm name "srs"
        gm_ds = encode_grid_mapping(ds, gm, gm_name="srs")
        ...
        gm_ds = encode_grid_mapping(ds.drop_vars("spatial_ref"), gm, force=True)
