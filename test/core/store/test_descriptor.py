...
class NewDataDescriptorTest(unittest.TestCase):
    def test_new_dataset_descriptor(self):
        ...
        self.assertExpectedDescriptor(descriptor, DatasetDescriptor, "dataset")

    def test_new_dataset_descriptor_with_bbox_from_metadata(self):
        cube = new_cube(
            variables=dict(a=4.1, b=7.4), x_name="you_did", y_name="not_expect_this"
        )
        cube.attrs.update(
            geospatial_lon_min=50,
        ...
        cube.not_expect_this.attrs.update(
            standard_name="not_expect_this", long_name="not_expect_this"
        )
        descriptor = new_data_descriptor("cube", cube)
    ...
    def test_new_ml_dataset_descriptor(self):
        ...
        self.assertExpectedDescriptor(
            descriptor, MultiLevelDatasetDescriptor, "mldataset"
        )
    ...
    def assertExpectedDescriptor(
        ...
        self.assertEqual(
            {"time": 5, "lat": 180, "lon": 360, "bnds": 2}, descriptor.dims
        )
...
class DatasetDescriptorTest(unittest.TestCase):
    ...
    def test_from_dict_var_descriptors_as_dict(self):
        ...
        self.assertIsInstance(descriptor.data_vars.get("A"), VariableDescriptor)
...
class VariableDescriptorTest(unittest.TestCase):
    ...
    def test_variable_descriptor_to_dict(self):
        ...
        expected = {
            ...
            "dims": ["dfjhrt", "sg"],
            "chunks": [3, 2],
            "attrs": {"ssd": 4, "zjgrhgu": "dgfrf", "fill_value": None},
        }
...
class JsonTest(unittest.TestCase):
    ...
    def test_attrs_to_json_dask(self):
        ...
        self.assertEqual(
            {"flag_names": "F1 F2 F3 F4 F5", "flag_values": [1, 2, 4, 8, 16]},
            _attrs_to_json(
                {
                    "flag_names": "F1 F2 F3 F4 F5",
