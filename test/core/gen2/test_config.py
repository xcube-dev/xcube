...
from xcube.core.gen2.config import CallbackConfig, CubeConfig, InputConfig, OutputConfig
...
class CubeConfigTest(unittest.TestCase):
    def test_from_dict(self):
        ...
        self.assertEqual(dict(title="S2L2A subset"), cube_config.metadata)
        self.assertEqual(
            dict(
                B03=dict(long_name="Band 3"),
                B04=dict(long_name="Band 4"),
    ...
    def test_drop_props(self):
        ...
        lesser_cube_config = cube_config.drop_props(["crs", "spatial_res", "bbox"])
        ...
        self.assertEqual(
            "variable_shames is not a property of"
