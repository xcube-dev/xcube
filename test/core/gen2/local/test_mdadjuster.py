...
class CubeMetadataAdjusterTest(unittest.TestCase):
    def test_metadata_adjusted_geo_crs(self):
        ...
        self.assertEqual({"long_name": "Total suspended matter"}, cube2.tsm.attrs)
    ...
    def test_metadata_adjusted_other_crs(self):
        ...
        self.assertAlmostEqual(53.0, cube2.attrs.get("geospatial_lon_min"), delta=0.001)
        self.assertAlmostEqual(10.0, cube2.attrs.get("geospatial_lat_min"), delta=0.001)
        self.assertAlmostEqual(
            0.001, cube2.attrs.get("geospatial_lon_resolution"), delta=0.0005
        )
        self.assertAlmostEqual(
            0.001, cube2.attrs.get("geospatial_lat_resolution"), delta=0.0005
        )
