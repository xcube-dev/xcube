...
class AddTimeCoordsTest(unittest.TestCase):
    ...
    def test_to_time_in_days_since_1970(self):
        ...
        self.assertEqual(17690.5, to_time_in_days_since_1970("2018-06-08 12:00"))
        self.assertEqual(17690.5, to_time_in_days_since_1970("2018-06-08T12:00"))
        self.assertEqual(
            18173.42625622898, to_time_in_days_since_1970("2019-10-04T10:13:48.538184")
        )
    ...
    def test_from_time_in_days_since_1970(self):
        self.assertEqual(
            ...
            str(
                from_time_in_days_since_1970(to_time_in_days_since_1970("201706071200"))
            ),
        )
        self.assertEqual(
            "2017-06-08T12:00:00.000000000",
            str(
                from_time_in_days_since_1970(to_time_in_days_since_1970("201706081200"))
            ),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            str(
                from_time_in_days_since_1970(
                    to_time_in_days_since_1970("2019-10-04T10:13:48.538184")
                )
            ),
        )
...
class GetTimeRangeTest(unittest.TestCase):
    ...
    def test_get_time_range_from_data_with_irregular_cftime_data(self):
        cube = new_cube(
            drop_bounds=True, time_freq="M", use_cftime=True, time_dtype=None
        )
        time_range = get_time_range_from_data(cube)
        self.assertIsNotNone(time_range)
        self.assertEqual("2010-01-31T00:00:00", pd.Timestamp(time_range[0]).isoformat())
...
class TimestampToIsoStringTest(unittest.TestCase):
    def test_it_with_default_res(self):
        self.assertEqual(
            "2018-09-05T00:00:00Z", timestamp_to_iso_string(np.datetime64("2018-09-05"))
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            timestamp_to_iso_string(pd.to_datetime("2019-10-04T10:13:48.538184")),
        )

    def test_it_with_ceil_round_fn(self):
        self.assertEqual(
            "2018-09-05T00:00:00Z",
            timestamp_to_iso_string(np.datetime64("2018-09-05"), round_fn="ceil"),
        )
        self.assertEqual(
            "2018-09-05T10:35:42Z",
            timestamp_to_iso_string(
                np.datetime64("2018-09-05 10:35:42"), round_fn="ceil"
            ),
        )
        self.assertEqual(
            "2018-09-05T10:35:43Z",
            timestamp_to_iso_string(
                np.datetime64("2018-09-05 10:35:42.164"), round_fn="ceil"
            ),
        )
        self.assertEqual(
            "2019-10-04T10:13:49Z",
            timestamp_to_iso_string(
                pd.to_datetime("2019-10-04T10:13:48.538184"), round_fn="ceil"
            ),
        )
    ...
    def test_it_with_floor_round_fn(self):
        self.assertEqual(
            "2018-09-05T00:00:00Z",
            timestamp_to_iso_string(np.datetime64("2018-09-05"), round_fn="floor"),
        )
        self.assertEqual(
            "2018-09-05T10:35:42Z",
            timestamp_to_iso_string(
                np.datetime64("2018-09-05 10:35:42"), round_fn="floor"
            ),
        )
        self.assertEqual(
            "2018-09-05T10:35:42Z",
            timestamp_to_iso_string(
                np.datetime64("2018-09-05 10:35:42.164"), round_fn="floor"
            ),
        )
        self.assertEqual(
            "2019-10-04T10:13:48Z",
            timestamp_to_iso_string(
                pd.to_datetime("2019-10-04T10:13:48.538184"), round_fn="floor"
            ),
        )

    def test_it_with_array_round_fn(self):
        var = [
            np.datetime64("2018-09-05 10:35:42.564"),
        ...
        values = (
            [timestamp_to_iso_string(var[0], round_fn="floor")]
    ...
    def test_it_with_invalid_round_fn(self):
        with pytest.raises(
            ValueError,
            match=r"round_fn must be one of" r" \('ceil', 'floor', 'round'\)",
        ):
            timestamp_to_iso_string(
                np.datetime64("2018-09-05 10:35:42.164"), round_fn="foo"
            )
