...
from xcube.util.tilegrid import GeographicTileGrid
...
class Crs84TileGridTest(TestCase):
    def test_it(self):
        ...
        self.assertEqual(False, tg.is_j_axis_up)
...
class ImageTileGridTest(TestCase):
    def test_it(self):
        ...
        self.assertEqual((0, 100.0), tg.origin)
        self.assertEqual(True, tg.is_j_axis_up)
...
class OpenLayersOptionsTest(unittest.TestCase):
    def test_geographic_only(self):
        tile_grid = ImageTileGrid(image_size=(7200, 3600),
                                  tile_size=(512, 512),
                                  crs='EPSG:32633',
                                  xy_res=180 / 3600,
                                  xy_min=(-180, -90),
                                  is_j_axis_up=True)
        self.assertIsNone(tile_grid_to_ol_xyz_source_options(
            tile_grid,
