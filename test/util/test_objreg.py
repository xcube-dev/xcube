...
from xcube.util.objreg import ObjRegistry, get_obj_registry, ObjRegistration
...
class ObjRegistryTest(unittest.TestCase):
    ...
    def test_put_illegal(self):
        ...
        self.assertEqual("obj must be an instance of <class 'test.util.test_objreg.B'>", f'{cm.exception}')
