...
ENV XCUBE_CCI_INSTALL_MODE=branch
ENV XCUBE_CCI_VERSION=master
...
RUN if [[ ${INSTALL_PLUGINS} == '1' ]]; then bash install_xcube.sh xcube-cci ${XCUBE_CCI_VERSION} ${XCUBE_CCI_INSTALL_MODE}; fi;
